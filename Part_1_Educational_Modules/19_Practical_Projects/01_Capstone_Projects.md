...
The sequence below is designed to move you from fundamentals into real LLM system building.
...
This project teaches you what frameworks normally hide:
...
If you understand this project well, later deep learning abstractions will make much more sense.
...
This is the project where you truly understand:
...
This introduces real modern model adaptation:

- PEFT
- LoRA and QLoRA
- instruction-style data
- practical GPU constraints
...
This is where you stop thinking only about model weights and start thinking about systems:
...
## Project 6: Build a Tool-Using Agent

**Goal:** Understand the shift from chatbots to agents.

*   **Task:** Build an assistant that can use search, a calculator, and a local file reader to complete multi-step tasks.
*   **Requirements:** Add a reasoning loop, tool selection, output verification, and a stopping condition.
*   **Stretch Goal:** Add approval for risky actions and a lightweight memory store.

## Project 7: Build a Modern Evaluation Suite

**Goal:** Learn how to judge whether an AI system is actually improving.

*   **Task:** Create a small benchmark set covering factuality, formatting, code quality, refusal behavior, and grounded answers.
*   **Requirements:** Compare outputs before and after fine-tuning or system changes.
*   **Stretch Goal:** Add regression testing so future changes do not silently break good behavior.
...
This order mirrors the real evolution from:

- raw neural network understanding
- to LLM construction
- to modern AI systems engineering
